...
DEFAULT_PATTERNS: tuple[IntentPattern, ...] = (
    ...
    IntentPattern(
        ...
        (
            "סריקת אבטחה לפרויקט",
            "סריקת פרויקט לאבטחה",
            "סריקת פרוייקט לאבטחה",
            "תסרקי את הפרויקט לאבטחה",
            "סרקי את הפרויקט לאבטחה",
            "תבדקי את הפרויקט לאבטחה",
            "תבדקי פרויקט אבטחה",
            "תבדקי פרוייקט אבטחה",
            "בדיקת אבטחה לפרויקט",
            "בדיקת אבטחה לפרוייקט",
            "בדיקת קוד בפרויקט",
            "בדיקת קוד בפרוייקט",
            "project security scan",
            "workspace security scan",
            "scan the project for security",
        ),
    ...
    IntentPattern(
        ...
        (
            ...
            "ip check",
            "classify ip",
            "classify network target",
        ),
        domain="network_intelligence",
    ),
    IntentPattern(
        "VPNStatusCheck",
        (
    ...
    IntentPattern(
        ...
        (
            ...
            "דוח רשת מקומי",
            "מצב הרשת",
            "תבדקי את הרשת המקומית",
            "תבדקי אם האינטרנט עובד",
            "בדיקת אינטרנט",
            "internet status",
